...
grep -rl jetpack . | xargs sed -i '' "s/jetpack/${GAME_NAME}/g"
grep -rl Jetpack . | xargs sed -i '' "s/Jetpack/${GAME_TITLE}/g"
grep -rl 3015 . | xargs sed -i '' "s/3015/${PORT}/g"
