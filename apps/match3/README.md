...
grep -rl match3 . | xargs sed -i '' "s/match3/${GAME_NAME}/g"
grep -rl Match 3 . | xargs sed -i '' "s/Match 3/${GAME_TITLE}/g"
grep -rl 3010 . | xargs sed -i '' "s/3010/${PORT}/g"
