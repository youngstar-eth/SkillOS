      ...
      <div className="w-full max-w-2xl">
        <div className="space-y-6 text-center">
          ...
          <p className="mx-auto max-w-lg text-base text-neutral-400 sm:text-lg">
            Stake 1 USDC, match a player, swap gems for 2 minutes. Deepest
            cascades + highest score wins the pool.
          </p>
        ...
        <div className="mt-16 grid gap-3 sm:grid-cols-3">
          {[
            ...
            },
            {
              n: "03",
              t: "Swap",
              d: "Same starting board, 2 minutes. Deep cascades win the pool.",
            },
          ].map((s) => (
            <div
              key={s.n}
        ...
        <div className="mt-8 rounded-xl border border-border-subtle bg-bg-elev p-5 text-sm text-neutral-400">
          ...
          <p>
            Every 3+ line of same-color gems scores{" "}
            <span className="font-mono text-neutral-200">matches × 10 × chainDepth</span>.
            A 3-match is <span className="font-mono">30</span>. Set up
            cascades: a follow-on 3-match in the same resolution scores{" "}
            <span className="font-mono">60</span>, the next{" "}
            <span className="font-mono">90</span>, and so on. Classic rule:
            illegal swaps (no match formed) are rejected.
          </p>
        </div>
