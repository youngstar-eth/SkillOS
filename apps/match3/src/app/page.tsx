      ...
      <div className="w-full max-w-2xl">
        <div className="space-y-6 text-center">
          ...
          <h1 className="text-4xl font-semibold tracking-tight sm:text-6xl">
            Match 3 duels <span className="text-skill">on Base</span>
          </h1>

          <p className="mx-auto max-w-lg text-base text-neutral-400 sm:text-lg">
            Stake 1 USDC, match a player, clear tiles by matching 3 or more.
            Higher score in 2 minutes wins the pool.
          </p>
