...
grep -rl crossy . | xargs sed -i '' "s/crossy/${GAME_NAME}/g"
grep -rl Crossy . | xargs sed -i '' "s/Crossy/${GAME_TITLE}/g"
grep -rl 3012 . | xargs sed -i '' "s/3012/${PORT}/g"
