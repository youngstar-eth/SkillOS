...
grep -rl helix . | xargs sed -i '' "s/helix/${GAME_NAME}/g"
grep -rl Helix . | xargs sed -i '' "s/Helix/${GAME_TITLE}/g"
grep -rl 3013 . | xargs sed -i '' "s/3013/${PORT}/g"
