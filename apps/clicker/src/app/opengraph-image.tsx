...
// underneath, single neon-lime rule, lime "skillos · clicker" accent and
...
export const alt =
  "SkillOS clicker — Skill economy infrastructure for self-evolving agents.";
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        {/* Per-app accent — lime "skillos · clicker" mono caption. */}
        <div
          style={{
            display: "flex",
            marginTop: 32,
