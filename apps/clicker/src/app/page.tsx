      ...
      <div className="w-full max-w-2xl">
        <div className="space-y-6 text-center">
          ...
          <p className="mx-auto max-w-lg text-base text-neutral-400 sm:text-lg">
            Stake 1 USDC, match a player, tap as fast as you can for 2
            minutes. Most taps wins the pool.
          </p>
        ...
        <div className="mt-16 grid gap-3 sm:grid-cols-3">
          {[
            ...
            },
            {
              n: "03",
              t: "Tap",
              d: "2 minutes, unlimited taps. Fastest fingers win the pool.",
            },
          ].map((s) => (
            <div
              key={s.n}
        ...
        <div className="mt-8 rounded-xl border border-border-subtle bg-bg-elev p-5 text-sm text-neutral-400">
          ...
          <p>
            Score = raw tap count. No upgrades, no combos, no power-ups —
            pure hand speed. Tap, click, space, or enter; every press
            counts. Ties (both reach the ceiling) broken by who submitted
            first.
          </p>
        </div>
