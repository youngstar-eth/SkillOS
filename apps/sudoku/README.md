# @skillbase/app-sudoku

Next.js app for the Sudoku solo-tournament flow on Base Sepolia. Per-app frontend; shared backend logic lives in `@skillbase/duel-backend`.
...
npm run dev -w @skillbase/app-sudoku
```
...
- Production subdomain: `sudoku.skillbase.games`
