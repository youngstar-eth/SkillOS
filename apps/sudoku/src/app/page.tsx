      ...
      <div className="w-full max-w-2xl">
        <div className="space-y-6 text-center">
          ...
          <p className="mx-auto max-w-lg text-base text-neutral-400 sm:text-lg">
            Stake 1 USDC, match a player, race to solve the same puzzle.
            Most cells correct in 2 minutes wins the pool.
          </p>
        ...
        <div className="mt-16 grid gap-3 sm:grid-cols-3">
          {[
            ...
            },
            {
              n: "03",
              t: "Duel",
              d: "Same puzzle, 2 minutes. Most cells correct wins the pool.",
            },
          ].map((s) => (
            <div
              key={s.n}
        ...
        <div className="mt-8 rounded-xl border border-border-subtle bg-bg-elev p-5 text-sm text-neutral-400">
          ...
          <p>
            Score = count of cells currently matching the solution, including
            the 41 givens. Range{" "}
            <span className="font-mono text-neutral-200">41</span>–
            <span className="font-mono text-neutral-200">81</span>. Ties
            (both solve fully) broken by who submitted first — speed still
            matters.
          </p>
        </div>
