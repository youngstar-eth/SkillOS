...
// underneath, single neon-lime rule, lime "skillos · sudoku" accent and
...
export const alt =
  "SkillOS sudoku — Skill economy infrastructure for self-evolving agents.";
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        {/* Per-app accent — lime "skillos · sudoku" mono caption. */}
        <div
          style={{
            display: "flex",
            marginTop: 32,
