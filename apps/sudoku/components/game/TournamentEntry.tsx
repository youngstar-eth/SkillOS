...
export function TournamentEntry({
  ...
  return (
    <div className="flex flex-col gap-3 rounded-lg border border-border bg-bg p-4 shadow-[0_2px_6px_rgba(6,27,49,0.04)]">
      <div>
      ...
      <div className="flex flex-col gap-2 sm:flex-row">
        <button
          ...
          className="min-h-[40px] flex-1 rounded-md border border-border bg-bg px-3 py-2 text-sm font-semibold text-fg hover:border-accent disabled:opacity-40"
        >
        ...
        <button
          ...
          className="min-h-[40px] flex-1 rounded-md bg-accent px-3 py-2 text-sm font-semibold text-white shadow-[0_4px_14px_rgba(99,91,255,0.35)] hover:bg-accent-deep disabled:opacity-40 disabled:shadow-none"
        >
...
function StatusRow({
  ...
  return (
    <div className="grid grid-cols-2 gap-x-2 gap-y-1 rounded-md border border-border bg-surface p-2 text-xs">
      ...
      {(approveError || enterError) && (
        <p className="col-span-2 mt-1 rounded border border-error/40 bg-error/5 p-2 text-error">
