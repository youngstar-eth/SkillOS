...
grep -rl hillclimb . | xargs sed -i '' "s/hillclimb/${GAME_NAME}/g"
grep -rl Hill Climb . | xargs sed -i '' "s/Hill Climb/${GAME_TITLE}/g"
grep -rl 3019 . | xargs sed -i '' "s/3019/${PORT}/g"
