    ...
    <div className="flex flex-col gap-3 rounded border border-border bg-surface p-4">
      ...
      <div className="flex flex-col gap-2 sm:flex-row">
        ...
        <button
          ...
          className="min-h-[40px] flex-1 rounded bg-accent px-3 py-2 text-sm font-bold text-[#0d1117] shadow-[0_0_18px_rgba(84,174,255,0.45)] hover:bg-accent/90 disabled:opacity-40 disabled:shadow-none"
        >
