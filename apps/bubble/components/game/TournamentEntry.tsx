  ...
  if (status === "entered") {
    return (
      <div className="rounded-xl border-2 border-accent/40 bg-accent/5 p-4">
        ...
        <p className="mt-1 text-xs text-muted">You are in. Pop away.</p>
      </div>
    );
  }

  return (
    <div className="flex flex-col gap-3 rounded-xl border-2 border-border bg-surface p-4 shadow-[0_6px_20px_rgba(255,100,150,0.1)]">
      <div>
      ...
      <div className="flex flex-col gap-2 sm:flex-row">
        <button
          ...
          className="min-h-[40px] flex-1 rounded-full border-2 border-border bg-surface-2 px-3 py-2 text-sm font-semibold text-fg hover:border-accent disabled:opacity-40"
        >
        ...
        <button
          ...
          className="min-h-[40px] flex-1 rounded-full bg-accent px-3 py-2 text-sm font-semibold text-white shadow-[0_8px_24px_rgba(255,100,150,0.4)] hover:bg-accent-deep disabled:opacity-40 disabled:shadow-none"
        >
