...
grep -rl pool . | xargs sed -i '' "s/pool/${GAME_NAME}/g"
grep -rl 8-Ball Pool . | xargs sed -i '' "s/8-Ball Pool/${GAME_TITLE}/g"
grep -rl 3018 . | xargs sed -i '' "s/3018/${PORT}/g"
