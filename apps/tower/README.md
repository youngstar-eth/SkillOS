# Tower Defense — MAS game template
...
grep -rl tower . | xargs sed -i '' "s/tower/${GAME_NAME}/g"
grep -rl Tower Defense . | xargs sed -i '' "s/Tower Defense/${GAME_TITLE}/g"
grep -rl 3017 . | xargs sed -i '' "s/3017/${PORT}/g"
