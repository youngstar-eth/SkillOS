...
export function TournamentEntry({
  ...
  if (status === "entered") {
    return (
      <div className="rounded border border-success/40 bg-success/10 p-4">
        ...
        <p className="mt-1 text-xs text-muted">You are in. Break out.</p>
      </div>
    );
  }
  ...
  return (
    <div className="flex flex-col gap-3 rounded border border-border bg-surface p-4">
      <div>
        <h3 className="text-h3 neon-cyan">
      ...
      <div className="flex flex-col gap-2 sm:flex-row">
        <button
          ...
          className="min-h-[40px] flex-1 rounded border border-border bg-surface-2 px-3 py-2 text-sm font-bold text-fg hover:border-synth-cyan disabled:opacity-40"
        >
        ...
        <button
          ...
          className="min-h-[40px] flex-1 rounded bg-synth-cyan px-3 py-2 text-sm font-bold text-bg shadow-[0_0_18px_rgba(82,174,255,0.5)] hover:bg-synth-cyan/90 disabled:opacity-40 disabled:shadow-none"
        >
