# Stickman Hook — MAS game template
...
grep -rl stickman . | xargs sed -i '' "s/stickman/${GAME_NAME}/g"
grep -rl Stickman Hook . | xargs sed -i '' "s/Stickman Hook/${GAME_TITLE}/g"
grep -rl 3016 . | xargs sed -i '' "s/3016/${PORT}/g"
