    ...
    return (
      <div className="win-raised">
        <div className="win-titlebar">
          <span>Tournament #{tournamentId.toString()}</span>
          <span className="opacity-75">◻ × ▢</span>
        </div>
        <div className="p-3 bg-window">
  ...
  return (
    <div className="win-raised">
      ...
      <div className="flex flex-col gap-2 p-3 bg-window">
        <p className="text-xs">
          Entry fee: <b>1 USDC</b> · gameId &ldquo;{gameLabel}&rdquo; · {durationLabel}
        </p>
        ...
        <div className="flex flex-col gap-2 sm:flex-row">
          <button
            ...
            className="win-raised active:win-pressed min-h-[28px] flex-1 px-3 py-1 text-xs disabled:opacity-50"
          >
          ...
          <button
            ...
            className="win-raised active:win-pressed min-h-[28px] flex-1 px-3 py-1 text-xs font-bold disabled:opacity-50"
          >
...
function StatusRow({
  ...
  return (
    <div className="win-inset grid grid-cols-2 gap-x-2 gap-y-1 p-2 text-[11px]">
      ...
      {status === "no_balance" && (
        <p className="col-span-2 mt-1 font-bold">
      ...
      {(approveHash || enterHash) && (
        <p className="col-span-2 mt-1 break-all">
      ...
      {(approveError || enterError) && (
        <p className="col-span-2 mt-1 text-[rgb(var(--color-danger))]">
