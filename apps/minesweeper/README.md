# @skillbase/app-minesweeper

Next.js app for the Minesweeper solo-tournament flow on Base Sepolia. Per-app frontend; shared backend logic lives in `@skillbase/duel-backend`.
...
npm run dev -w @skillbase/app-minesweeper
```
...
- Production subdomain: `minesweeper.skillbase.games`
