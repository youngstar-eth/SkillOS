      ...
      <div className="w-full max-w-2xl">
        <div className="space-y-6 text-center">
          ...
          <p className="mx-auto max-w-lg text-base text-neutral-400 sm:text-lg">
            Stake 1 USDC, match a player, clear the same 9×9 board. Most
            safe cells revealed in 2 minutes wins the pool.
          </p>
        ...
        <div className="mt-16 grid gap-3 sm:grid-cols-3">
          {[
            ...
            },
            {
              n: "03",
              t: "Duel",
              d: "Same mine layout, 2 minutes. Most safe cells wins the pool.",
            },
          ].map((s) => (
            <div
              key={s.n}
        ...
        <div className="mt-8 rounded-xl border border-border-subtle bg-bg-elev p-5 text-sm text-neutral-400">
          ...
          <p>
            Score = safe cells revealed (
            <span className="font-mono text-neutral-200">0</span>–
            <span className="font-mono text-neutral-200">71</span>). Step on
            a mine, the game ends — you keep whatever you revealed up to
            that point. No first-click safety: both duelists see the same
            mine layout from turn one. Ties (both fully clear) broken by
            who submitted first.
          </p>
        </div>
