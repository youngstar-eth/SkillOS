...
// underneath, single neon-lime rule, lime "skillos · minesweeper" accent and
...
export const alt =
  "SkillOS minesweeper — Skill economy infrastructure for self-evolving agents.";
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        {/* Per-app accent — lime "skillos · minesweeper" mono caption. */}
        <div
          style={{
            display: "flex",
            marginTop: 32,
