...
grep -rl geometry . | xargs sed -i '' "s/geometry/${GAME_NAME}/g"
grep -rl Geometry . | xargs sed -i '' "s/Geometry/${GAME_TITLE}/g"
grep -rl 3014 . | xargs sed -i '' "s/3014/${PORT}/g"
