...
grep -rl solitaire . | xargs sed -i '' "s/solitaire/${GAME_NAME}/g"
grep -rl Solitaire . | xargs sed -i '' "s/Solitaire/${GAME_TITLE}/g"
grep -rl 3009 . | xargs sed -i '' "s/3009/${PORT}/g"
