...
Next.js app for the Wordle solo-tournament flow on Base Sepolia. Per-app frontend; shared backend logic lives in `@skillos/duel-backend`.
...
npm run dev -w @skillos/app-wordle
```
...
- Production subdomain: `wordle.skillos.games`
