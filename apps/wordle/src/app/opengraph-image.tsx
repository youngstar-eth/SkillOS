...
// underneath, single neon-lime rule, lime "skillos · wordle" accent and
...
export const alt =
  "SkillOS wordle — Skill economy infrastructure for self-evolving agents.";
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        {/* Per-app accent — lime "skillos · wordle" mono caption. */}
        <div
          style={{
            display: "flex",
            marginTop: 32,
