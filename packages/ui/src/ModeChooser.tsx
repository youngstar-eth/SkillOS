...
function SoloCard({ href }: { href: string }) {
  return (
    ...
    >
      ...
      <span className="mt-6 inline-flex items-center justify-center rounded-xl bg-skill px-4 py-2.5 text-sm font-semibold text-black transition group-hover:bg-yellow-400">
        Play Solo →
      </span>
    </Link>
  );
