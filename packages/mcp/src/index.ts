...
function usage(exitCode = 0): never {
  process.stderr.write(
    [
      ...
      '  SKILLOS_PRIVATE_KEY       0x-prefixed 32-byte hex; required for write tools',
      '  SKILLOS_AGENT_ID          ERC-8004 tokenId owned by wallet; required for agent tools',
      ...
      '',
      'Tools registered: list_tournaments, get_tournament, get_leaderboard,',
      '  fund_pool, submit_score, agent_register, fetch_match_replay,',
      '  fetch_cohort_snapshot. See README for schemas + auth requirements.',
      '',
    ].join('\n'),
  );
