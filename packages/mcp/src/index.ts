...
function usage(exitCode = 0): never {
  process.stderr.write(
    [
      ...
      '  SKILLOS_AGENT_ID          ERC-8004 tokenId override; OPTIONAL — auto-resolved from W when unset',
      ...
      '  SKILLOS_EXPLORER_URL      Blockscout origin for W→tokenId resolution override',
      '',
