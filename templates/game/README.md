# __GAME_TITLE__ — MAS game template
...
grep -rl __GAME_NAME__ . | xargs sed -i '' "s/__GAME_NAME__/${GAME_NAME}/g"
grep -rl __GAME_TITLE__ . | xargs sed -i '' "s/__GAME_TITLE__/${GAME_TITLE}/g"
grep -rl __PORT__ . | xargs sed -i '' "s/__PORT__/${PORT}/g"
...
npm run dev         # local dev at :__PORT__
```
