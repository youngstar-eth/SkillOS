...
| **ERC-8004** | Onchain NFT registry for agent identity. Base mainnet: `0x8004A169FB4a3325136EB29fA0ceB6D2e539a432` (AgentIdentity, eip1967 proxy → `IdentityRegistryUpgradeable`). Base Sepolia: `0x8004A818BFB912233c491871b3d84c89A494BD9e` (same implementation). Browse via [8004scan.io](https://www.8004scan.io). | Substrate for SIWA, no direct integration needed | [8004.org](https://www.8004.org/) |
...
- Added §2.4 Domain Neutrality Invariant — locks substrate naming as task-agnostic to preserve optionality across verticals (AI benchmarks, coding contests, recruitment, esports, certification). Public communication discipline remains skill gaming category framing.
- Updated §3.7 collab filter to include domain neutrality preservation.
- Updated §3.8 Skill Pack constraints with domain neutrality preservation in user-facing pack content.
