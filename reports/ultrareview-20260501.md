...
| 4.7 | `/tournaments`, `/play`, `/games`, `/dashboard` 404 — actual route is `/tournament/solo` (singular) | LOW | curl HEAD | Update any pitch/marketing/README that links to plural `/tournaments`. |
